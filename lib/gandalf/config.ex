defmodule Gandalf.Config do
  ...
  def repo, do: Application.get_env(:gandalf, :repo)

  def scopes, do: Application.get_env(:gandalf, :scopes)

  def app_scopes, do: Enum.join(scopes(), ",")

  def grant_types, do: Application.get_env(:gandalf, :grant_types)

  def auth_strategies, do: Application.get_env(:gandalf, :auth_strategies)
  ...
  def expires_in, do: Application.get_env(:gandalf, :expires_in)

  def renderer, do: Application.get_env(:gandalf, :renderer)
